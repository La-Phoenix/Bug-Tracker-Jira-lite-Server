    ...
    public partial class AddChatSystem : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TypingStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TypingStatuses_ChatRooms_RoomId",
                        column: x => x.RoomId,
                        principalTable: "ChatRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TypingStatuses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatParticipants_RoomId_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TypingStatuses_RoomId_UserId",
                table: "TypingStatuses",
                columns: new[] { "RoomId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TypingStatuses_UserId",
                table: "TypingStatuses",
                column: "UserId");
        }
